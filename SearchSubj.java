 ...
 * @author jomsa
 */
public class SearchSubj extends javax.swing.JDialog {

    /**
     * Creates new form Search_Student
     */
    public SearchSubj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        Table_edit model = new Table_edit(
        new Object[][]{}, 
        new String[]{"Code", "Description", "Units", "Specialization", "Department", "Time", "Day", "Type"}
        );
    ...
    private void loadAllData() {// Shows all the subjects whenever the search appears
        String sqlQuery = "SELECT subj_code, subj_desc, units, spec, dept, sched_time, sched_day, subj_type"
                          + " FROM subject";
    ...
    private void initComponents() {
        ...
        searchPnl.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Subject", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 24))); // NOI18N
        ...
        searchResTbl.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
        searchResTbl.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        ...
        searchTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Description", "Units", "Specialization", "Department", "Time", "Day", "Type"
            }
        ) {
        ...
        try (Connection con = Connect_DB.connect()) {
            ...
            try {
                for (int row : selectedRows) {
                    String subj_code = (String) model.getValueAt(row, 0); // Get the subject_code from the table
                    deleteSubject(con, subj_code);
                }
    ...
    private void editBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBttnActionPerformed
        // TODO add your handling code here:
        EditSubject edit = new EditSubject(this, true);
        edit.setVisible(true);
    }//GEN-LAST:event_editBttnActionPerformed

    private String buildSqlQuery(String keyword) {
        StringBuilder sqlQuery = new StringBuilder("SELECT subj_code, subj_desc, units, spec, dept, sched_time, sched_day, subj_type"
                          + " FROM subject ");
        ...
        if (hasKeyword) {
            ...
            sqlQuery.append("(subj_code LIKE ? OR subj_desc LIKE ? OR units LIKE ? OR spec LIKE ? OR dept LIKE ? OR sched_time LIKE ? OR sched_day LIKE ? OR subj_type LIKE ?)"); // Use correct columns
        }
    ...
    private void setQueryParameters(PreparedStatement pst, String keyword) throws SQLException {
        ...
        if (!keyword.isEmpty()) {
            ...
            pst.setString(parameterIndex++, likeKeyword);  // subj_code
            pst.setString(parameterIndex++, likeKeyword);  // subj_desc
            pst.setString(parameterIndex++, likeKeyword);  // units
            pst.setString(parameterIndex++, likeKeyword);  // spec
            pst.setString(parameterIndex++, likeKeyword);  // dept
            pst.setString(parameterIndex++, likeKeyword);  // sched_time
            pst.setString(parameterIndex++, likeKeyword);  // sched_day
            pst.setString(parameterIndex++, likeKeyword);  // subj_type
        }
    }
    ...
    private void deleteSubject(Connection con, String subj_code) throws SQLException {
        String query =  "DELETE FROM subject WHERE subj_code = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchSubj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
