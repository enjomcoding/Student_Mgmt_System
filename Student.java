...
public class Student extends javax.swing.JDialog {
    ...
    private void saveBttnActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        // Call the addStudent method with all the validated parameters
        SMS add = new SMS();
        add.addStudent(studentDetails, studentDemographics, studentFamily, comboInfo, 
            yearLevel, dobString, gender, studentID, program);
        this.dispose();
    }
